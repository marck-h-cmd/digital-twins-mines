...
TRANSLATIONS = {
    "es": {
        ...
        "business_scoring_title": "Tabla 2.1: Matriz de Decisión y Ponderación Multicriterio de Negocio",
        "business_scoring_caption": "Gobernanza de Inteligencia Artificial para toma de decisiones operacionales. Pondera rigor estadístico con requerimientos de mina: latencia sub-milisegundo, interpretabilidad ante auditorías de seguridad y facilidad de mantenimiento.",
        "weights_config_title": "⚙️ Configurar Ponderaciones Multicriterio (Pesos de Negocio)",
        "weight_perf_label": "Rendimiento Predictivo (F1 + AUC)",
        "weight_latency_label": "Velocidad de Inferencia (Baja Latencia)",
        "weight_interp_label": "Interpretabilidad Técnica (XAI)",
        "weight_maint_label": "Mantenibilidad y Despliegue",
        "business_winner_badge": "🏆 Ganador de Negocio",
        "business_recommended_badge": "⭐ Recomendado",
        "business_score_col": "Puntuación de Negocio (%)",
        "fig_radar_title": "Figura 5.1: Radar Multicriterio de Arquitecturas (Balance Operacional)",
    ...
    "en": {
        ...
        "business_scoring_title": "Table 2.1: Business Multi-Criteria Decision & Scoring Matrix",
        "business_scoring_caption": "Artificial Intelligence Governance for operational decision-making. Balances statistical rigor with underground mining requirements: sub-millisecond latency, safety audit interpretability, and production maintainability.",
        "weights_config_title": "⚙️ Configure Multi-Criteria Weights (Business Criteria)",
        "weight_perf_label": "Predictive Performance (F1 + AUC)",
        "weight_latency_label": "Inference Speed (Low Latency)",
        "weight_interp_label": "Technical Interpretability (XAI)",
        "weight_maint_label": "Maintainability & Deployment",
        "business_winner_badge": "🏆 Business Champion",
        "business_recommended_badge": "⭐ Recommended",
        "business_score_col": "Business Score (%)",
        "fig_radar_title": "Figure 5.1: Multi-Criteria Architecture Radar (Operational Balance)",
